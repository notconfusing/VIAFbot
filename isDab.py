...
#files
wikilinksfile = open("dabtest.out")#should be wikilinksforbot.out when real
...
for wikilink in wikilinks:
    ...
    '''Find redirects or deletions, after all this file could be 6 months out of date'''
    try:
    ...
    if isDab(validatedPage):
        print validatedPage.title() + " was a disambiguation page \n"
        viafbotrun.write(validatedPage.title() + " was a disambiguation page \n")
        continue
    else: 
        print validatedPage.title() + " was not a disambiguation page \n"
